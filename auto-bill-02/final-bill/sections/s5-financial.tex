...
{\footnotesize
\begin{xltabular}{\textwidth}{@{}L{3.4cm} L{2.6cm} Y L{2.2cm}@{}}
\hline\noalign{\vskip 0.04cm}
...
investigator & Part 54 certification or disclosure with the application & Not
public (review)\\
\hline\noalign{\vskip 0.04cm}
...
\end{mermaidfig}
\vspace{-0.2cm}
\figcaption{Figure 6. The annual financial-data reporting flow (gray-scale
Mermaid sequence as TikZ): the sponsor writes per-run cost records to the
...
not a fee-bearing submission \cite{usc-379j, usc-379i}.}
...
2022, which authorize fees through fiscal year 2027 - rather than through a
new statutory fee \cite{pl-mdufa5, fda-mdufa-rates}.}
...
\hline\noalign{\vskip 0.04cm}
Verification-records system (build, then operate) & 9.0 & 6.0 & 4.5 & 3.0 &
3.0 & 25.5\\
\hline\noalign{\vskip 0.04cm}
...
account they meet in, the four activities of Table 6 they pay for, and the
