...
\end{xltabular}}
\vspace{-0.8cm}
\figcaption{Table 7. Estimated budget authority and outlays, fiscal years 2027
through 2031 (dollars in millions, illustrative). Each outlay cell applies the
60/30/10 spend-out to the Table 6 series; 53.5 plus the 4.5 after the window
equals the 58.0 authorized.}
...
{\footnotesize
\begin{xltabular}{\textwidth}{@{}Y R{3.4cm}@{}}
\hline\noalign{\vskip 0.04cm}
...
class priced as a percent of the standard PMA fee under 21 U.S.C. \S~379j,
...
an agency for generally applicable implementation \cite{usc-paygo-2010,
house-rule-xxi}.}
...
\hline\noalign{\vskip 0.04cm}
Discretionary cost & 58.0 million dollars authorized over five years
(illustrative); outlays per Table 7, subject to appropriations\\
\hline\noalign{\vskip 0.04cm}
Intergovernmental mandate (UMRA) & None\\
\hline\noalign{\vskip 0.04cm}
...
and earmark determinations this pre-introduction estimate supports, each
