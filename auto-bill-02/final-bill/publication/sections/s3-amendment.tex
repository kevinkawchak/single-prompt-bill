...
{\footnotesize
\begin{xltabular}{\textwidth}{@{}L{3.7cm} L{0.9cm} L{0.8cm} L{1.3cm} Y R{1.3cm}@{}}
\hline\noalign{\vskip 0.04cm}
\textbf{Gate} & \textbf{Min.\ agree.} & \textbf{Max.\ CV} & \textbf{Hard
...
\end{mermaidfig}
\vspace{-0.7cm}
\figcaption{Figure 3. The gate decision rule with the cost-record checkpoint: ACCEPT, BLOCK, and ESCALATE keep their carried
...
date; and this Act does not disturb the February 2, 2026, date of
