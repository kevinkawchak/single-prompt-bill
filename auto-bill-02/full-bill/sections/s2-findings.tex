...
\end{mermaidfig}
\vspace{-0.2cm}
\figcaption{Figure 1. Evidence-to-law-to-cost lineage (gray-scale Mermaid as
TikZ): the method and pipeline, the hard engineering proof, the bill, the
amendment, the two visual versions, and this financial version, which prices
what the prior five recorded.}
...
{\footnotesize
\begin{xltabular}{\textwidth}{@{}L{1.5cm} Y L{3.1cm} R{1.7cm} L{1.7cm}@{}}
\hline\noalign{\vskip 0.04cm}
...
51 tests; a 1 ACCEPT, 5 BLOCK, 1 ESCALATE gate surface & 12,600 &
\href{https://doi.org/10.5281/zenodo.20372501}{20372501}\\
\hline\noalign{\vskip 0.04cm}
VVUQ-02 & Generated ten-gate humanoid surgical codebase and autonomous
...
\hline\noalign{\vskip 0.04cm}
VVUQ-03 & Standalone Physical AI Oncology Trial Bill synthesized from the
...
\hline\noalign{\vskip 0.04cm}
VVUQ-04 & Bill recast as an amendment to the Federal Food, Drug, and Cosmetic
Act & New section 360e-5 plus ten conforming amendments & 8,300 &
\href{https://doi.org/10.5281/zenodo.20485580}{20485580}\\
\hline\noalign{\vskip 0.04cm}
Total & The four-work evidence-to-law record & About eleven days of
autonomous, real-time work & 48,400 & -\\
\hline
\end{xltabular}}
\vspace{-0.9cm}
